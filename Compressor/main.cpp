...
//
//int doTestIteration(Compressor::ComputationType computationType, char * logFileName) {
...
//
//	Compressor::Args compressorArgs;
...
//	compressorArgs.computationLimit = Compressor::ComputationLimit::FITNESS_COUNT;
...
//	//}
//	doTestIteration(Compressor::ComputationType::LOCAL_SEARCH, NULL);
//}
...
int main(int argc, char* argv[]) {
	...
	compressorArgs.computationType = Compressor::ComputationType::LOCAL_SEARCH;
	compressorArgs.computationLimit = Compressor::ComputationLimit::FITNESS_COUNT;
	compressorArgs.maxComputationTimeSecs = 60 * 10;
	compressorArgs.maxFitnessEvaluationCount = 40000;
	compressorArgs.useCuda = true;
	compressorArgs.logImprovementToConsole = false;
